...
# https://github.com/nutonomy/nuscenes-devkit/pull/300 >>> motmetrics==1.1.3
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataroot', type=str, default='/home/user/dataset/nuscenes/v1.0-trainval',
